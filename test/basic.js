...
describe('[html unit test]', function () {
  ...
  describe('test customize tag', function () {
    
    it('test customize tag', function () {
      assert.equal(htmler.tag('nav')('top').html('haha'), '<nav class="top">haha</nav>');
    });

    it('test customize single tag', function () {
      assert.equal(htmler.singleTag('nav')('top'), '<nav class="top">');
    });  
